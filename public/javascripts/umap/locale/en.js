var locale = {
    ...
    "Custom": "Custom",
    "Default": "Default",
    "Define output link to open a new window on polygon click.": "Define output link to open a new window on polygon click.",
    "Delete": "Delete",
    ...
    "Do you want to display the data layers control?": "Do you want to display the data layers control?",
    "Do you want to display the scale control?": "Do you want to display the scale control?",
    "Do you want to display zoom control?": "Do you want to display zoom control?",
    ...
    "Fill opacity, from 0.1 to 1.0 (opaque).": "Fill opacity, from 0.1 to 1.0 (opaque).",
    "Format": "Format",
    "From zoom": "From zoom",
    ...
    "Opacity, from 0.1 to 1.0 (opaque).": "Opacity, from 0.1 to 1.0 (opaque).",
    "Optional. Same as color if not set.": "Optional. Same as color if not set.",
    "Optionnal.": "Optionnal.",
    "Paste here your data": "Paste here your data",
    "Path weight in pixels. From 0 to 10.": "Path weight in pixels. From 0 to 10.",
    ...
    "Whether to display or not the Polygon path.": "Whether to display or not the Polygon path.",
    "Whether to fill the path with color.": "Whether to fill the path with color.",
    "Zoom in": "Zoom in",
    "Zoom out": "Zoom out",
    ...
    "stroke": "stroke",
    "symbol of the icon": "symbol of the icon",
    "template to use for the popup": "template to use for the popup",
    "type of icon": "type of icon",
    "weight": "weight",
    "yes": "yes",
    "Editing": "Editing",
    "Must be a CSS valid name (eg.: DarkBlue or #123456)": "Must be a CSS valid name (eg.: DarkBlue or #123456)",
    ...
    "height": "height",
    "width": "width",
    "Add a permanent label": "Add a permanent label",
    "Clustered": "Clustered",
    ...
    "Empty": "Empty",
    "Merge geometry with edited feature": "Merge geometry with edited feature",
    ...
    "A string that defines the stroke dash pattern. Ex.: «5, 10, 15».": "A string that defines the stroke dash pattern. Ex.: «5, 10, 15».",
    "Do you want to display the «more» control?": "Do you want to display the «more» control?",
    "Auto": "Auto",
    "Autostart slideshow when map is loaded?": "Autostart slideshow when map is loaded?",
    "Default: name": "Default: name",
    "Delay between elements (in milliseconds)": "Delay between elements (in milliseconds)",
    "Property to use for sorting features": "Property to use for sorting features",
    "Set a value for adding a slideshow": "Set a value for adding a slideshow",
    "Slideshow": "Slideshow",
    ...
    "You can use formatting and &#123;properties&#125; from your features.": "You can use formatting and &#123;properties&#125; from your features.",
