...
class YmCatTranslatorTest extends FlatSpec with Matchers {
  ...
  "Translator" should "handle 1-level categories from carrida.ru yml price" in {
    ...
    r("448070")  shouldBe  CAT_TREE_CORE / "Электроника и Фото" / "Навигационное оборудование" / "GPS-навигаторы"
    r("440745")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Колесные диски"
    r("445961")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Аксессуары"
    //TODO r("465595")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Грузовые машины"  // Грузовые автомобили Попадает в "Автомобили"
    r("469410")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Аксессуары" / "Радар-детекторы"
    List(
      CAT_TREE_CORE / "Авто, мото" / "Аксессуары" / "Универсальные зарядные устройства и инверторы",
      CAT_TREE_CORE / "Авто, мото" / "Запчасти" / "Зарядные устройства для аккумуляторов"
    ) should contain (r("469514"))
    r("440681")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Шины"
    //TODO r("451162")  shouldBe  CAT_TREE_CORE / "Все для дома и дачи" / "Дача, сад и огород" / "Мойки высокого давления" // Автомойки
    r("464188")  shouldBe  CAT_TREE_CORE / "Строительство и ремонт" / "Водоснабжение и водоотведение" / "Водоочистка"
    ...
    r("450040")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Аксессуары" / "Автомобильные видеорегистраторы"
    r("462017")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Автокосметика"    // TODO Две категории в одной. Хз чо тут делать.
    ...
    r("455123")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Автохимия" / "Моторные масла"
    r("451963")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Аксессуары" / "Автомобильные холодильники"
    r("446968")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Аудио- и видеотехника" / "Автомагнитолы"
    r("446748")  shouldBe  CAT_TREE_CORE / "Авто, мото" / "Аудио- и видеотехника" / "Автоакустика"
