...
trait DropSpec extends js.Object {
  ...
  val drop: js.UndefOr[js.Function2[IItem, DropTargetMonitor, js.UndefOr[js.Object]]] = js.undefined
  /** Fired when a drag operation begins */
  val hover: js.UndefOr[js.Function2[IItem, DropTargetMonitor, Unit]] = js.undefined
  val canDrop: js.UndefOr[js.Function2[IItem, DropTargetMonitor, Unit]] = js.undefined
