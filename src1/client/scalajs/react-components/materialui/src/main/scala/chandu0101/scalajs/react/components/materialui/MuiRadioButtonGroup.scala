...
case class MuiRadioButtonGroup[T](
  ...
  defaultSelected: js.UndefOr[T]                            = js.undefined,
  ...
  onChange:        js.UndefOr[(ReactEvent, T) => Callback]  = js.undefined,
  /** Override the inline-styles of the root element. */
  style:           js.UndefOr[CssProperties]                = js.undefined,
  /** The `value` of the currently selected radio button. */
  valueSelected:   js.UndefOr[T]                            = js.undefined,
  /** checked if true
...
implicit def ev2T(t: T | js.Array[T]): js.Any = t.asInstanceOf[js.Any]
    ...
    val f = JsComponent[js.Object, Children.Varargs, Null](Mui.RadioButtonGroup)
    f(props)(children: _*)
  }
}
...
trait MuiRadioButtonGroupM extends js.Object {
  ...
  def hasCheckAttribute(radioButton: js.Any): Boolean = js.native

  def setSelectedValue(newSelectionValue: String): Unit = js.native

  def updateRadioButtons(newSelection: js.Any): Unit = js.native
}
