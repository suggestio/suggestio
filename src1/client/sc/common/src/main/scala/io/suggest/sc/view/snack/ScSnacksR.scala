package io.suggest.sc.view.snack
...
import io.suggest.sc.model.{CloseError, MScRoot, OnlineCheckReset}
import io.suggest.sc.model.inx.{IndexSwitchNodeClick, MInxSwitch}
import io.suggest.sc.view.dia.err.ScErrorDiaR
import io.suggest.sc.view.dia.first.WzFirstR
import io.suggest.sc.view.inx.IndexSwitchAskR
