package io.suggest.sc.controller.menu
...
import io.suggest.sc.model.{MScRoot, OnlineCheckConn, ResetUrlRoute, SetErrorState}
import io.suggest.sc.model.dia.err.MScErrorDia
import io.suggest.sc.model.inx.MScIndexState
import io.suggest.sjs.common.async.AsyncUtil.defaultExecCtx
import io.suggest.sc.model.menu.{DlAppOpen, DlInfoResp, ExpandDlApp, MDlAppDia, MkAppDlInfoReq, PlatformSetAppDl, QrCodeExpand, TechInfoDlAppShow}
import io.suggest.sc.util.api.IScAppApi
