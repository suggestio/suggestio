package io.suggest.sc.view.dia.dlapp
...
import io.suggest.sc.model.menu._
...
class DlAppDiaR(
                 ...
                 qrCodeRender       : Option[ModelProxy[QrCodeRenderArgs] => VdomNode],
                        ...
                        MuiAccordionDetails()(
                          ...
                          MuiTable()(
                            MuiTableBody()(
                              ...
                              // qr-код:
                              qrCodeRender.whenDefinedNode { qrCodeRenderF =>
                                MuiTableRow()(
                                  MuiTableCell(
                                    new MuiTableCellProps {
                                      val colSpan = 2
                                    ...
                                    MuiButton(
                                      ...
                                      qrCodeRenderF(
                                        dlAppDiaProxy.resetZoom(
                                          QrCodeRenderArgs(
                                            data    = dlInfo.url,
                                            sizePx  = if (dlAppDia.qrCodeExpanded) 270 else 70,
                                          )
                                        )
                                      )
                                    ),
