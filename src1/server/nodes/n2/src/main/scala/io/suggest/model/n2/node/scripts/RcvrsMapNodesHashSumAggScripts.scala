package io.suggest.model.n2.node.scripts
...
class RcvrsMapNodesHashSumAggScripts extends DocHashSumsAggScripts {
  ...
  import io.suggest.model.n2.node.meta.MMeta.Fields.Basic.BASIC_FN
  import io.suggest.model.n2.node.meta.MBasicMeta.Fields.NAME_FN
  import MNodeFields.Edges.EDGES_FN
  import io.suggest.model.n2.edge.MNodeEdges.Fields.OUT_FN
  import io.suggest.model.n2.edge.MEdge.Fields.{PREDICATE_FN, INFO_FN, NODE_ID_FN, ORDER_FN}
  import io.suggest.model.n2.edge.MEdgeInfo.Fields.GEO_POINT_FN
