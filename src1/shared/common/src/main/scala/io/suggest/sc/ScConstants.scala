...
object ScConstants {
  ...
  object Welcome {
    ...
    /** Передача параметров между клиентом и сервером требует именования аргументов рендера. */
    object Args {

      /** Название параметра с цветом фона. */
      def BG_COLOR_FN = "a"

      /** Название параметра с фоновой картинкой. */
      def BG_IMAGE_FN = "b"

      /** Название параметра с картинкой переднего плана.*/
      def FG_IMAGE_FN = "c"
