...
trait ScIndexAdOpen extends ScFocusedAds with ScIndexNodeCommon {
  ...
  override protected def _focusedAds(logic: FocusedAdsLogicJsStr)(implicit request: AbstractRequestWithPwOpt[_]): Future[Result] = {
   ...
   */
  private def _goToProducerIndex(adnId: String, focLogic: FocusedAdsLogicJsStr)(implicit request: AbstractRequestWithPwOpt[_]): Future[Result] = {
