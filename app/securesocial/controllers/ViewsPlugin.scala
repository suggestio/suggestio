...
trait MailTemplates {
   ...
   */
  def getAlreadyRegisteredEmail(user: IProfile)(implicit request: RequestHeader, lang: Lang): (Option[Txt], Option[Html])
   ...
   * @return a String with the text and/or html body for the email
   */
  def getWelcomeEmail(user: IProfile)(implicit request: RequestHeader, lang: Lang): (Option[Txt], Option[Html])
   ...
   * @return a String with the text and/or html body for the email
   */
  def getSendPasswordResetEmail(user: IProfile, token: String)(implicit request: RequestHeader, lang: Lang): (Option[Txt], Option[Html])
   ...
   * @return a String with the text and/or html body for the email
   */
  def getPasswordChangedNoticeEmail(user: IProfile)(implicit request: RequestHeader, lang: Lang): (Option[Txt], Option[Html])
