...
object MAdv {
  ...
  val CURRENCY_CODE_OPT_PARSER = get[Option[String]]("currency_code")
  val CURRENCY_PARSER = CURRENCY_CODE_OPT_PARSER.map { ccOpt =>
    val cc = ccOpt getOrElse CurrencyCodeOpt.CURRENCY_CODE_DFLT
